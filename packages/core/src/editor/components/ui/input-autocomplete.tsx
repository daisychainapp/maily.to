    ...
    <div className={cn('mly:relative')} ref={containerRef}>
      <label className="mly:relative">
        <input
          ...
          className={cn(
            'mly-input-padding mly:h-7 mly:w-40 mly:rounded-md mly:bg-white mly:text-sm mly:text-midnight-gray mly:hover:bg-soft-gray mly:focus:bg-soft-gray mly:focus:outline-hidden',
            className
          )}
          onKeyDown={(e) => {
